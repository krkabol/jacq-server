...
final class Version20240621071847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE photos (id INT AUTO_INCREMENT NOT NULL, herbarium_id INT DEFAULT NULL, `filename` VARCHAR(255) NOT NULL, width INT DEFAULT NULL, height INT DEFAULT NULL, specimen_id VARCHAR(255) DEFAULT NULL, finalized TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_876E0D98A90ABA9 (`filename`), INDEX IDX_876E0D9DD127992 (herbarium_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
